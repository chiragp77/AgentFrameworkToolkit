...
public static class ServiceCollectionExtensions
{
    ...
    /// <summary>
    /// Register an OpenRouterEmbeddingFactory as a Singleton
    /// </summary>
    /// <param name="services">The IServiceCollection collection</param>
    /// <param name="connection">Connection Details</param>
    /// <returns>The ServiceCollection</returns>
    public static IServiceCollection AddOpenRouterEmbeddingFactory(this IServiceCollection services, OpenRouterConnection connection)
    {
        return services.AddSingleton(new OpenRouterEmbeddingFactory(connection));
    }
    ...
    /// <param name="apiKey">The API Key</param>
    /// <returns>The ServiceCollection</returns>
    public static IServiceCollection AddOpenRouterEmbeddingFactory(this IServiceCollection services, string apiKey)
    {
        return services.AddSingleton(new OpenRouterEmbeddingFactory(apiKey));
    }
}
